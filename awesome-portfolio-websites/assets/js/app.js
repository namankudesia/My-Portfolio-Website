...
<a class="navbar-brand" href="">Naman Kudesia </a>
   ...
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="-80 0 650 400" preserveAspectRatio="xMinYMin meet">
     ...
     <defs>
       <linearGradient id="paint0_linear" x1="432.641" y1="56.6686" x2="44.1018" y2="338.225" gradientUnits="userSpaceOnUse">
         <stop offset="0.0001" stop-color="#008080" />
         <stop offset="1" stop-color="#008080" stop-opacity="0.05" />
       </linearGradient>
     </defs>
   </svg>
 </div>
...
<div style="text-align: center; margin: 20px;">
  ...
  <svg
    ...
    width="1.5em"
    height="1.5em"
    style="animation: rotate 2s infinite linear;"
  ...
  <p class="tag" style="animation: fadeIn 3s ease-in-out infinite;">
    Ignite your passion for knowledge; every insight fuels your personal evolution.
  </p>
</div>

<style>
  /* Animation for rotating the SVG */
  @keyframes rotate {
    from {
  ...
  <img src="assets/images/contact form/contact.svg" alt="Description of the image">
</a>
 </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/_8pA1hHi_v3" method="POST" accept-charset="UTF-8" >
    ...
    <div class="rounded-social-buttons tag">
     <a class="social-button twitter" href="https://x.com/namankudesia" target="_blank">
        <!-- Replacing the SVG code with an image link -->
        <img class="twitter-icon-footer" src="assets/images/x.svg" alt="Twitter Icon" width="35" />
    </a>
    

    <a class="social-button linkedin" href="https://www.linkedin.com/in/naman-kudesia-b5622aa2/" target="_blank" >
    ...
    <a class="social-button instagram" href="https://www.instagram.com/_.naamaan._/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/namankudesia" target="_blank">
    ...
    if ($(window).scrollTop() < $(window).height()) {
      ...
      if (
        ...
        // 838 should be changed if footer's height is changed so that the button changes it's color exactly when it hits the footer (preferably 14 less than the computer height of the footer)
          $("#btnScrollToTop").css("background-color", "#008080");
      } else {
          $("#btnScrollToTop").css("background-color", "#008080");
      }
    }
